...
Функционал: Вход в gmail
  ...
  Структура сценария: : авторизация на почте работает корректно
    ...
    Если появилось окно "Подтвердите, что это действительно вы", то пользователь вводит "<резервный email>"
    И пользователь "<login>" авторизован
    ...
    Примеры:
    | login                 | password        |резервный email|
